...
export default function OurWork() {
  ...
  return (
    <div className=" flex flex-col md:flex-row  items-center gap-10 md:gap-0 py-10  bg-gray-300 md:justify-between md:py-14 md:px-20 text-gray-600 shadow-lg m-5 sm:m-5 lg:mx-48 xl:mx-56 2xl:mx-60 bg-gallery">
      ...
      <Link href="/Gallery">
        {" "}
        <button className="  bg-blue-900 text-white font-bold rounded-xl w-44 md:w-56 md:text-lg text-sm hover:bg-blue-700 transition duration-300 ease-in-out h-11 mt-4 sm:mt-0 flex flex-row justify-center items-center">
          {t("See Works")}
        </button>
      </Link>
    </div>
