...
export default function Consultation() {
  ...
  return (
    <div className=" flex flex-col md:flex-row justify-center items-center gap-10 md:gap-0 py-10  bg-gray-300 md:justify-between md:py-14 md:px-20 text-gray-600 shadow-lg">
